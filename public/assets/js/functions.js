...
(function ($) {
  ...
  $(document).scroll(function () {
    ...
    if (scroll >= height) {
      $(".menu-block")
        .addClass("navbarr-fixed-top animated fadeInDown")
        .delay(2000)
        .fadeIn();
    } else if (scroll <= height) {
      $(".menu-block").removeClass("navbarr-fixed-top animated fadeInDown");
    } else {
      $(".menu-block").removeClass("navbarr-fixed-top animated fadeInDown");
    } /* set sticky menu - end */
  ...
  $(document).ready(function ($) {
    ...
    if (scroll >= height - 500) {
      $(".menu-block").addClass("navbarr-fixed-top").delay(2000).fadeIn();
    } else if (scroll <= height) {
      $(".menu-block").removeClass("navbarr-fixed-top");
    } else {
      $(".header-main").removeClass("navbarr-fixed-top");
    } /* set sticky menu - end */

    $(
      '.navbarr-nav li a[href*="#"]:not([href="#"]), .site-logo a[href*="#"]:not([href="#"])'
    ).on("click", function (e) {
      var $anchor = $(this);
